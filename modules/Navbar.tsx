...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-10 px-[68px]">
        <Link href={"/"}><Image style={{ width: 'auto', height: 'auto' }} src={"/images/websiteLogo.svg"} alt="website-logo" width={136} height={71}/></Link>
        ...
        <div className="flex gap-5">
            <Button size={"icon"} className="cursor-pointer rounded-full bg-transparent border-2 border-black pt-0.5"><ScrollText className="text-black" /></Button>
